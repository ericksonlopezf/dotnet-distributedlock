...
public sealed class MariaDbDistributedLockHandleTests
{
    [Fact]
    public void Constructor_NullConnection_ThrowsArgumentNullException()
    {
        var act = () => new MariaDbDistributedLockHandle(
            null!,
            "res-key",
            "res-id",
            NullLogger.Instance);
    ...
    {
        var conn = new FakeDbConnection();
        var expectedHash = BitConverter.ToInt64(SHA256.HashData(Encoding.UTF8.GetBytes("mariadb-order-123")), 0);

        await using var handle = new MariaDbDistributedLockHandle(
            conn,
            "mariadb-order-123",
            "mariadb-order-123",
            NullLogger.Instance,
        ...
        handle.ResourceId.Should().Be("mariadb-order-123");
    ...
    public async Task Keepalive_WhenSuccessful_MaintainsActiveHandleToken()
    {
        ...
        var handle = new MariaDbDistributedLockHandle(
            conn,
            "res-key",
            "res-id",
            NullLogger.Instance,
    ...
    public async Task ExecuteKeepalive_WhenDisposed_ReturnsEarlyWithoutQuery()
    {
        ...
        var method = typeof(MariaDbDistributedLockHandle).GetMethod("ExecuteKeepalive", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
    ...
    public void ExecuteKeepalive_WhenCtsDisposed_HandlesObjectDisposedExceptionGracefully()
    {
        ...
        var ctsField = typeof(MariaDbDistributedLockHandle).GetField("_handleLostCts", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
